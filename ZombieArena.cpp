...
//if you write this function here then there's no need to write arena.cpp separately, if you wrote the arena.cpp then just import it in the header file and call the create background function with respective/actual parameters in the main function of this program 
...
//most important function to be considered which creates a horde of the zombies
